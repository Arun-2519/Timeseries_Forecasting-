...
features = ['Size','Sleeve','Length','Range','Mrp','Month','Weekday','Week']

st.title("📊 Sales Forecasting App")

# User input: number of future days
...
# Last date (replace with your dataset’s max date if available)
...
if st.button("Predict"):
    ...
    st.dataframe(future_df[['Date','Month','Weekday','Predicted_Qty']])
